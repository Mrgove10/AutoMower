...
/* harmony import */ var _jsons_states__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./jsons/states */ "./src/jsons/states.js");
...
ws.onmessage = function (event) {
    ...
    ;(0,_utils_utils__WEBPACK_IMPORTED_MODULE_1__.updatevalue)('debugData', JSON.stringify(event))
    console.log(event)
    ;(0,_utils_utils__WEBPACK_IMPORTED_MODULE_1__.updatevalue)('test', event.BatVolt)
    ;(0,_utils_utils__WEBPACK_IMPORTED_MODULE_1__.updatevalue)('stateIcon', _jsons_states__WEBPACK_IMPORTED_MODULE_0__.mowerStates[event.State].icon)
    ;(0,_utils_utils__WEBPACK_IMPORTED_MODULE_1__.updatevalue)('stateDisplay', _jsons_states__WEBPACK_IMPORTED_MODULE_0__.mowerStates[event.State].humanName)
}
...
const APIUrl = 'http://192.168.1.38:1880/AM'
let config = {}
let schedule = {}
...
/* harmony import */ var _jsons_states__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./jsons/states */ "./src/jsons/states.js");
/* harmony import */ var _schedule__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./schedule */ "./src/schedule.js");
...
async function main () {
    ...
    ;(0,_config__WEBPACK_IMPORTED_MODULE_0__.getSchedule)()
    ;(0,_schedule__WEBPACK_IMPORTED_MODULE_2__.createTable)()
    await (0,_schedule__WEBPACK_IMPORTED_MODULE_2__.addSchedule)()
}
...
window.stop = async function () {
    ...
    await axios.get(_config__WEBPACK_IMPORTED_MODULE_0__.APIUrl + '/STOP')
    // sendCommand('STATE_CHANGE', 'IDLE')
}

window.setStateIcon = function (State) {
    document.getElementById('stateDisplay').innerHTML = `${_jsons_states__WEBPACK_IMPORTED_MODULE_1__.mowerStates[State].icon} ${_jsons_states__WEBPACK_IMPORTED_MODULE_1__.mowerStates[State].humanName}`
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "mowerStates": () => (/* binding */ mowerStates)
/* harmony export */ });
const mowerStates = {
    1: {
        humanName: 'Idle',
...
const mymap = leaflet_dist_leaflet__WEBPACK_IMPORTED_MODULE_0__.map('mapid').setView([40.505, 5], 3)

leaflet_dist_leaflet__WEBPACK_IMPORTED_MODULE_0__.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
...
/* harmony export */ });
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config */ "./src/config.js");
/* harmony import */ var _jsons_days__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./jsons/days */ "./src/jsons/days.js");
...
function createTable () {
    // table header
    _jsons_days__WEBPACK_IMPORTED_MODULE_1__.days.forEach((day) => {
...
async function addSchedule () {
    const schedule = await (0,_config__WEBPACK_IMPORTED_MODULE_0__.getSchedule)()
...
/******/ 	__webpack_require__("./src/routing.js");
/******/ 	__webpack_require__("./src/map.js");
/******/ 	__webpack_require__("./src/comm.js");
/******/ 	// This entry module is referenced by other modules so it can't be inlined
/******/ 	__webpack_require__("./src/schedule.js");
