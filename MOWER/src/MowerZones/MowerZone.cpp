...
void mowZoneStepsInit(void)
{
    ...
    g_mowZoneSteps[MOW_ZONE_2][3].action = ACT_FOLLOWWIRE;  g_mowZoneSteps[MOW_ZONE_2][3].param1 = 70;   g_mowZoneSteps[MOW_ZONE_2][3].param2 = ACT_CW;
    ...
    g_mowZoneSteps[MOW_ZONE_4][1].action = ACT_SPOTTURN;    g_mowZoneSteps[MOW_ZONE_4][1].param1 = 35;   g_mowZoneSteps[MOW_ZONE_4][1].param2 = ACT_CCW;
    g_mowZoneSteps[MOW_ZONE_4][2].action = ACT_FORWARD;     g_mowZoneSteps[MOW_ZONE_4][2].param1 = 5;    g_mowZoneSteps[MOW_ZONE_4][2].param2 = 100;
    ...
    g_mowZoneSteps[MOW_ZONE_4][4].action = ACT_FOLLOWWIRE;  g_mowZoneSteps[MOW_ZONE_4][4].param1 = 120;  g_mowZoneSteps[MOW_ZONE_4][4].param2 = ACT_CCW;
